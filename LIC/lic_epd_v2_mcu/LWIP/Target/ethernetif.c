...
static void low_level_init(struct netif *netif)
{
  ...
  /* !!! Ёто очень важный таинственный костыль! ≈сли самый первый байт мака нечетный, */
  /* то нихрена не работает! ѕочему - неизвестно. !!!!111 */
  /****************************************************************************/
  if ( cfg_eth->HW_addr[0] % 2 ) cfg_eth->HW_addr[0]--;
  /****************************************************************************/
  
  heth.Init.MACAddr = cfg_eth->HW_addr;
